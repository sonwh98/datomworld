(ns dao.postgraphics.raster
  "Platform-neutral shading + rasterization core: the reference fragment model
   (sRGB, Blinn-Phong, texture sampling) that the GPU shaders mirror, plus the
