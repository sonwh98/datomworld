...
The architecture described here (including `yang.clojure` emitting `:yin/macro-expand` nodes) was fully eradicated during the U16 Phase 2 macro redesign (2026-09-18). Macros are now handled entirely via the stream transducer topology defined in `docs/design/yin.vm.macro.md`.
