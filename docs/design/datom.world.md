...
- **Engineering Team Roster**: See [`docs/agents/team/README.md`](../agents/team/README.md) for engineering team roles and LLM model assignments.
- **Agent Delegation**: See [`docs/agents/calling-agents.md`](../agents/calling-agents.md) for delegating tasks/reviews to other coding agents (`agy`, `glm`, `deepseek`).
