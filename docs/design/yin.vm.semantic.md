...
(2026-09-18; status corrected 2026-09-25) published `"v2"`; `"v3"` adds
`:define` and the reserved name `yin/def`. The revision history of the
`"v2"` contract is in `yin.vm.ucf-revisions.md` (2026-09-25).
